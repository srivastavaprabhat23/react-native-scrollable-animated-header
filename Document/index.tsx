...
import { SafeAreaView, View,Animated,Platform,Easing,RefreshControl,ScrollView } from 'react-native'
import { Text } from '../Text'
import Header from '../Header/index'
import styles from './styles'
import { styles as headerStyles } from '../Header/styles'
import FontAwesome from 'react-native-vector-icons/Ionicons'
import { ScrollView2 } from '../ScrollContext'
import { heightPercentageToDP as hp} from 'react-native-responsive-screen'
import { useScroller } from '../ScrollContext'

export const Document = () => {
  const [childScrollOffset,setChildScrollOffset]=useState(hp('30%'))

  return (
    <SafeAreaView style={{ flex: 1, flexDirection: 'column',backgroundColor:'transparent'}}>
     <Header height={childScrollOffset}  ></Header>
      <ScrollView
        style={{paddingTop:hp('30%')}}
        onScroll={e=>setChildScrollOffset(e.nativeEvent.contentOffset.y)}
      >
